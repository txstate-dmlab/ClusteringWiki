...
<script type="text/javascript" src="includes/js/credentials.pack.js"></script>
...
<!-- being index -->
	...
	<div id="rpanel">
	<strong>Please enter your email address below and click Submit.</strong> <br><br>
			<div id="regForm" class="cmxform">
				<form id="reminderForm" action="reminder.html" onSubmit="return false;">
				...
				<br>
				<div>
					<span class="regLink center" ><a href="javascript:sendReminder()">Submit</a></span>
				</div>
				</form>
			</div> <br/>
